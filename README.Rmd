...
This example demonstrates Bayesian shrinkage estimation of treatment effects across subgroups using a **fixed effects model** with a Regularized Horseshoe prior, applied to the `shrink_data` package dataset with three subgrouping variables.
