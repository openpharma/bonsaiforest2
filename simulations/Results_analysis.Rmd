...
write.csv(all_truth_coefficients, 
          file = "Results/truth_subgroup_coefficients.csv", 
          row.names = FALSE)

message("Truth subgroup coefficients saved to Results/truth_subgroup_coefficients.csv")
...
write.csv(all_overall_effects, 
          file = "Results/truth_overall_treatment_effects.csv", 
          row.names = FALSE)

message("Overall treatment effects saved to Results/truth_overall_treatment_effects.csv")
...
# Save as PNG
ggsave("plots/standardized_rmse_all_endpoints.png", plot = p, 
...
# Save as PNG
ggsave("plots/rmse_all_endpoints_raw.png", plot = p_raw, 
       width = 8.27, height = 11.69, units = "in", dpi = 300)
```
...
# Save as PNG
ggsave("plots/absolute_bias_all_endpoints.png", plot = p_bias, 
       width = 8.27, height = 11.69, units = "in", dpi = 300)
```
...
# Save as PNG
ggsave("plots/r2d2_comparison_unshrunk_x4.png", plot = p_r2d2, 
       width = 8.27, height = 11.69, units = "in", dpi = 300)
```
...
focus_list <- lapply(names(endpoint_results), function(ep) {
  ...
  df <- sp %>%
    ...
    select(Endpoint, scenario_no, join_key, Estimator, RMSE, Bias, Coverage) %>%
...
# Save plot
ggsave("plots/forest_scenario3_r2d2_comparison.png", plot = forest_r2d2_scen3, 
...
# Save plot
ggsave("plots/forest_scenario2_tte.png", plot = forest_tte, 
       width = 8, height = 6, dpi = 300, bg = "white")
```
...
# Save plot
ggsave("plots/forest_scenario2_binary.png", plot = forest_binary, 
       width = 8, height = 6, dpi = 300, bg = "white")
```
...
# Save plot
ggsave("plots/forest_scenario2_count.png", plot = forest_count, 
       width = 8, height = 6, dpi = 300, bg = "white")
```
...
# Save plot
ggsave("plots/forest_scenario2_continuous.png", plot = forest_continuous, 
       width = 8, height = 6, dpi = 300, bg = "white")
```
...
```{r table_continuous}
create_performance_table(subgroup_performance_list$continuous, endpoint_results$continuous$params)
```
...
# Save RMSE plot
ggsave("plots/tte_rmse_all_scenarios.png", width = 14, height = 10, dpi = 300, bg = "white")
```
...
# Save Bias plot
ggsave("plots/tte_bias_all_scenarios.png", width = 14, height = 10, dpi = 300, bg = "white")
```
...
# Save RMSE plot
ggsave("plots/binary_rmse_all_scenarios.png", width = 14, height = 10, dpi = 300, bg = "white")
```
...
# Save Bias plot
ggsave("plots/binary_bias_all_scenarios.png", width = 14, height = 10, dpi = 300, bg = "white")
```
...
# Save RMSE plot
ggsave("plots/count_rmse_all_scenarios.png", width = 14, height = 10, dpi = 300, bg = "white")
```
...
# Save Bias plot
ggsave("plots/count_bias_all_scenarios.png", width = 14, height = 10, dpi = 300, bg = "white")
```
...
# Save RMSE plot
ggsave("plots/continuous_rmse_all_scenarios.png", width = 14, height = 10, dpi = 300, bg = "white")
```
...
# Save Bias plot
ggsave("plots/continuous_bias_all_scenarios.png", width = 14, height = 10, dpi = 300, bg = "white")
```
