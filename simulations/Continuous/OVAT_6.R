...
base_file_name <- paste(ENDPOINT_ID, "ovat_6", prior_names_str, "no_update", sep = "_")
...
# --- 7. Run All Tasks in Parallel ---
cat(sprintf("\n--- Starting PARALLEL run for %d tasks on %d cores... ---\n",
            total_tasks, num_cores))

# This now runs from 1 to N, as the pre-compile step is gone
