...
beautify_cont_estimator <- function(estimator_name) {
  dplyr::case_when(
    ...
    # Global Horseshoe
        grepl("Global_Horseshoe.*delta_10", estimator_name) ~ "Global - Horseshoe(τ₀ =δ<sub>plan</sub>/10, s=2*σ<sub>plan</sub>)",
            grepl("Global_Horseshoe.*delta_100", estimator_name) ~ "Global - Horseshoe(τ₀ =δ<sub>plan</sub>/100, s=2*σ<sub>plan</sub>)",
    grepl("Global_Horseshoe.*delta_half", estimator_name) ~ "Global - Horseshoe(τ₀ =δ<sub>plan</sub>/2, s=2*σ<sub>plan</sub>)",
    grepl("Global_Horseshoe.*sigma_plan", estimator_name) ~ "Global - Horseshoe(τ₀ =σ<sub>plan</sub>, s=2*σ<sub>plan</sub>)",
    grepl("Global_Horseshoe.*delta_plan$", estimator_name) ~ "Global - Horseshoe(τ₀ =δ<sub>plan</sub>, s=2*σ<sub>plan</sub>)",
    # OVAT HN
...
cont_plot_data <- cont_plot_data %>%
  mutate(estimator_display = ifelse(estimator=="Global_Horseshoe_global_delta_100", "Global - Horseshoe(τ₀ =δ_plan/100, s=2*σ_plan)",
                                    estimator_display))
...
cont_color_map <- c(
  ...
  "Global - Horseshoe(τ₀ =δ<sub>plan</sub>/100, s=2*σ<sub>plan</sub>)" = "purple",
  "Global - Horseshoe(τ₀ =δ<sub>plan</sub>/10, s=2*σ<sub>plan</sub>)" = "palegreen2",
  "Global - Horseshoe(τ₀ =δ<sub>plan</sub>/2, s=2*σ<sub>plan</sub>)" = "palegreen3",
  "Global - Horseshoe(τ₀ =δ<sub>plan</sub>, s=2*σ<sub>plan</sub>)" = "forestgreen",
  "Global - Horseshoe(τ₀ =σ<sub>plan</sub>, s=2*σ<sub>plan</sub>)" = "darkgreen"
)
