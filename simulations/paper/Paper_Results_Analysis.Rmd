...
beautify_cont_estimator <- function(estimator_name) {
  dplyr::case_when(
    ...
    estimator_name == "subgroup" ~ "Subgroup",
    # Global HN
    grepl("Global_HN.*phi_delta_half", estimator_name) ~ "Global - HN(φ=δ_plan/2)",
    grepl("Global_HN.*phi_sigma_plan", estimator_name) ~ "Global - HN(φ=σ_plan)",
    grepl("Global_HN.*phi_delta_plan$", estimator_name) ~ "Global - HN(φ=δ_plan)",
    # Global Horseshoe
        grepl("Global_Horseshoe.*delta_10", estimator_name) ~ "Global - Horseshoe(τ_0 =δ_plan/10, s=2*σ_plan)",
            grepl("Global_Horseshoe.*delta_100", estimator_name) ~ "Global - Horseshoe(τ_0 =δ_plan/100, s=2*σ_plan)",
    grepl("Global_Horseshoe.*delta_half", estimator_name) ~ "Global - Horseshoe(τ_0 =δ_plan/2, s=2*σ_plan)",
    grepl("Global_Horseshoe.*sigma_plan", estimator_name) ~ "Global - Horseshoe(τ_0 =σ_plan, s=2*σ_plan)",
    grepl("Global_Horseshoe.*delta_plan$", estimator_name) ~ "Global - Horseshoe(τ_0 =δ_plan, s=2*σ_plan)",
    # OVAT HN
    grepl("OVAT_HN.*phi_delta_half", estimator_name) ~ "OVAT - HN(φ=δ_plan/2)",
    grepl("OVAT_HN.*phi_sigma_plan", estimator_name) ~ "OVAT - HN(φ=σ_plan)",
    grepl("OVAT_HN.*phi_delta_plan$", estimator_name) ~ "OVAT - HN(φ=δ_plan)",
    TRUE ~ estimator_name
  )
}
```
...
cont_plot_data <- cont_plot_data %>%
  mutate(estimator_display = ifelse(estimator=="Global_Horseshoe_global_delta_100", "Global - Horseshoe(τ_0 =δ_plan/100, s=2*σ_plan)",
                                    estimator_display))
...
cont_color_map <- c(
  "Subgroup" = "red",
  "Population" = "orange",
  "OVAT - HN(φ=δ_plan/2)" = "skyblue",
  "OVAT - HN(φ=δ_plan)" = "royalblue",
  "OVAT - HN(φ=σ_plan)" = "navy",
  "Global - Horseshoe(τ_0 =δ_plan/100, s=2*σ_plan)" = "purple",
  "Global - Horseshoe(τ_0 =δ_plan/10, s=2*σ_plan)" = "palegreen2",
  "Global - Horseshoe(τ_0 =δ_plan/2, s=2*σ_plan)" = "palegreen3",
  "Global - Horseshoe(τ_0 =δ_plan, s=2*σ_plan)" = "forestgreen",
  "Global - Horseshoe(τ_0 =σ_plan, s=2*σ_plan)" = "darkgreen"
)
...
cont_color_map <- c(
  ...
  "OVAT - HN(φ=δ_plan)" = "royalblue",
  "OVAT - HN(φ=σ_plan)" = "navy",
  "Global - Horseshoe(τ_0 =δ_plan/10, s=2*σ_plan)" = "palegreen1",
  "Global - Horseshoe(τ_0 =δ_plan/2, s=2*σ_plan)" = "palegreen3",
  "Global - Horseshoe(τ_0 =σ_plan, s=2*σ_plan)" = "forestgreen",
  "Global - Horseshoe(τ_0 =δ_plan, s=2*σ_plan)" = "darkgreen"
)
