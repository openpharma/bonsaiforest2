# -----------------------------------------------------------------
# RUN NAIVE SUBGROUP ANALYSIS FOR SUNFISH TRIAL
#
# This script runs the naive subgroup analysis for the SUNFISH
...
cache_file <- file.path(RESULTS_DIR, paste0("SUNFISH_subgroup.rds"))
