# -----------------------------------------------------------------
# RUN NAIVE POPULATION ANALYSIS FOR SUNFISH TRIAL
#
# This script runs the naive population (overall) analysis for the
# SUNFISH continuous endpoint (MFM32 change from baseline).
# -----------------------------------------------------------------
...
cache_file <- file.path(RESULTS_DIR, paste0("SUNFISH_population.rds"))
