...
# Set unique seed based on script name to ensure independent parallel execution
# Hash the script name to get a reproducible but unique seed
script_name <- "TTE_Horseshoe_mid"
...
PRIOR_SPECIFICATIONS <- list(
  horseshoe_mid = list(prior = "horseshoe(scale_global = 0.0053)", stanvars = NULL)
)
# ------------------------
