...
# 3. Uses Regularized Horseshoe prior with scale_global=δ_plan/2, scale_slab=δ_plan.
...
# Define the prior: Regularized Horseshoe with theta_0=delta_plan/2, s=delta_plan
theta_0 <- delta_plan / 2
s <- delta_plan
...
PRIOR_SPECIFICATIONS <- list(
  RHS_theta0_delta_plan_half_s_delta_plan = list(prior = paste0("horseshoe(df = 1, scale_global = ", theta_0, ", scale_slab = ", s, ")"), stanvars = NULL)
)
# ------------------------
