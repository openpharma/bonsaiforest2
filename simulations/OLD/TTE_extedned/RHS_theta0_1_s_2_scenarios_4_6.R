...
# Prior: Regularized Horseshoe with θ₀=1, s=2 (brms default)
# Scenarios: 4-6
#
# This script:
...
# 3. Uses Regularized Horseshoe prior with scale_global=1, scale_slab=2.
...
# Define the prior: Regularized Horseshoe with theta_0=1, s=2
theta_0 <- 1
s <- 2

message(paste("Defining Regularized Horseshoe prior with theta_0 =", theta_0, "and s =", s, "..."))

PRIOR_SPECIFICATIONS <- list(
  RHS_theta0_1_s_2 = list(prior = paste0("horseshoe(df = 1, scale_global =", theta_0, ", scale_slab =", s, ")"), stanvars = NULL)
)
# ------------------------
