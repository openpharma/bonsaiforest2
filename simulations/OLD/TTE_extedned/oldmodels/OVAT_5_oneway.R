...
# ===
# === STRATEGY:
# === 1. Process only Scenario 5 data
...
cat(sprintf("Successfully loaded %d datasets from scenario 5.\n", length(flat_named_list)))
...
base_file_name <- paste(ENDPOINT_ID, "ovat_5_oneway", prior_names_str, sep = "_")
