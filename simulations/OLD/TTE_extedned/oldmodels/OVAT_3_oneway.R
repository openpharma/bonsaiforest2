...
# ===
# === STRATEGY:
# === 1. Process only Scenario 3 data
...
cat(sprintf("Successfully loaded %d datasets from scenario 3.\n", length(flat_named_list)))
