...
# ===
# === STRATEGY:
# === 1. Process only Scenario 6 data
...
cat(sprintf("Successfully loaded %d datasets from scenario 6.\n", length(flat_named_list)))
...
base_file_name <- paste(ENDPOINT_ID, "ovat_6_oneway", prior_names_str, sep = "_")
