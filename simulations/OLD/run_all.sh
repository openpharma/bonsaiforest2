...
# --- Configuration: Define the simulation list (CONSOLIDATED: Scenarios 1-12) ---
data_types=("Continuous")
models=(
  "RHS_theta0_delta_plan_s_2delta_plan_scenarios_4_6"
  "RHS_theta0_delta_plan_s_2delta_plan_scenarios_1_3"
)
