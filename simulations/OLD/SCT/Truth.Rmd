---
title: "SCT Truth Computation"
output: html_document
date: "`r Sys.Date()`"
---

# Calculate True Treatment Effects for SCT Simulation

This script computes the theoretical true treatment effects (overall and by subgroup) for all 6 SCT scenarios.
...
# Subgroup definitions (matching SCT covariates)
...
message(paste("✅ Saved SCT truth to:", save_file))
```
