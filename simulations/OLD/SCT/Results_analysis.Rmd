---
title: "SCT Simulation Results Analysis"
output: 
  html_document:
    toc: true
    toc_float: true
...
# SCT Simulation Analysis

This document analyzes the performance of different estimators in the SCT Part 2 trial simulation across 6 scenarios with varying degrees of regional and treatment heterogeneity.
...
cat("Analyzing SCT simulation results...\n")
...
ggplot(plot_data, 
  ...
  labs(
    title = "Standardized Overall RMSE Across SCT Scenarios",
...
kbl(performance_table,
    caption = "Performance Metrics for SCT Simulation",
    booktabs = TRUE,
...
ggplot(bias_summary, 
  ...
  scale_color_brewer(palette = "Set1") +
  labs(
    title = "Mean Absolute Bias Across SCT Scenarios",
...
ggplot(coverage_by_scenario, 
  ...
  scale_color_brewer(palette = "Set1") +
  labs(
    title = "95% CI/Credible Interval Coverage Across SCT Scenarios",
    y = "Coverage (%)",
    x = "Simulation Scenario",
    color = "Estimator"
  ) +
