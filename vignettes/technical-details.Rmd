...
$$\eta_i = \underbrace{\beta_0 + \beta_{\text{treat}}s_i + \sum \beta^{\text{prog, shrunk}} x_i + \sum \beta^{\text{prog, unshrunk}} x_i + \sum \beta^{\text{extra}} u_i}_{\text{Prognostic Component}} + \underbrace{\sum \beta^{\text{pred, shrunk}} z_i + \sum \beta^{\text{pred, unshrunk}} z_i}_{\text{Predictive Component}}
