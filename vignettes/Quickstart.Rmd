...
The package enables the implementation of both a **global modeling approach** [@wolbers2025using], that estimates all main (prognostic) and interaction (predictive) effects in a single model, and a **One-Variable-At-a-Time (OVAT)** approach [@wang2024bayesian], that estimates the interaction effects using a different model for each subgrouping variable.
