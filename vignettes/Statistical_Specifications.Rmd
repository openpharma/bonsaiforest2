...
$$\beta_1, \ldots, \beta_K \sim N(0,\tau^2) \text{ with } \tau \sim HN(\phi)$$
...
$$\beta_k|\lambda_k, \tau, c \sim N(0,\tau^2\tilde{\lambda}_k^2)\text{ with } \tilde{\lambda}_k^2 = c^2 \lambda_k^2 / (c^2 + \tau^2 \lambda_k^2)$$

with hyper-priors:
$$\tau\sim C^+(0,\tau_0^2), \; \lambda_k \sim C^+(0,1)\; (k=1,\ldots,K), \text{ and } c^2 \sim \textrm{Inv-Gamma}(\nu/2,\nu s^2 /2).$$
