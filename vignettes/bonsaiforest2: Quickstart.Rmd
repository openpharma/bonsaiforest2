---
title: "bonsaiforest2: Quickstart"
...
To inspect the results, you can extract the estimates as a data frame.

```{r ex-extract-summary, eval=TRUE}
# Extract the summary table
summary_table <- as.data.frame(continuous_summary)
# or just continuous_summary$estimates

print(summary_table)
#>   subgroup_variable subgroup_level   estimate posterior_median   lower_ci
#> 1           Overall        Overall -2.7719461       -2.7885406 -5.1507204
#> 2            region           APAC -2.7915523       -2.8042457 -5.7369651
#> 3            region             EU -2.6896263       -2.7013862 -5.5936306
#> 4            region             NA -2.7432729       -2.7427845 -5.6517112
#> 5       comorbidity             No -2.8406560       -2.8362453 -5.4578119
#> 6       comorbidity            Yes -2.6105341       -2.6235128 -5.4740193
#>     upper_ci
#> 1 -0.4239868
#> 2  0.2045155
#> 3  0.2114771
